                ...
                <Box>
                    <div className='card-login card-login-tabs'>
                        <Tabs value={value} onChange={handleChange} variant="fullWidth" aria-label="basic tabs example">
                            <Tab sx={{ minWidth: '250px', textTransform: 'capitalize' }} className='card-login card-login-btns' label="Iniciar Sesión" {...a11yProps(0)} />
                            <Tab sx={{ minWidth: '250px', textTransform: 'capitalize' }} className='card-login card-login-btns' label="Regístrate" {...a11yProps(1)} />
                        </Tabs>
                    </div>
                </Box>
                            ...
                            <div className="mt-5">
                                <FormControl fullWidth>
                                    ...
                                    >
                                        ...
                                        {!loadingis && <span className="text">Iniciar Sesión</span>}
                                    </Button>
                                </FormControl>
                            </div>
                        </div>
                        ...
                        <div className='card-login card-login-lrcont'>
                            ...
                            <div className="mt-3">
                                <PswFieldOne
                                    ...
                                    icon={{ url: '/svg/icons/psw_frm.svg' }}
                                    value={RGpsw}
                                    onChange={e => onChangeInput("rgpassword", e.target.value)}
                                ></PswFieldOne>
                            </div>
                            <div className="mt-3">
                                <TextFieldOne
                                    ...
                                    icon={{ url: '/svg/icons/usr_frm.svg' }}
                                    value={RGnmc}
                                    onChange={e => onChangeInput("rgnamecomp", e.target.value)}
                                ></TextFieldOne>
                            </div>
                            <div className="mt-3">
                                <TextFieldOne
                                    ...
                                    icon={{ url: '/svg/icons/usr_frm.svg' }}
                                    value={RGape}
                                    onChange={e => onChangeInput("rgapellido", e.target.value)}
                                ></TextFieldOne>
                            </div>
                            <div className="mt-5">
                                <FormControl fullWidth>
